...
//class ColoredActor(name: String, val color: Color) : Actor(name)
//class ColoredText(text: String, override var actor: Actor?, val color: Color) : Text(text) {
//    infix fun on(storyContentBuilder: StoryContentBuilder) {
//        storyContentBuilder.getStoryRef().replaceAll {
//            if (it is Text && it.uuid == this.uuid) this
//            else it
//        }
//    }
//
//}
//
//infix fun Text.withColor(color: Color): ColoredText {
//    return ColoredText(this.text, this.actor, color).apply { uuid = this@withColor.uuid }
//}
//
//// TODO https://github.com/varabyte/kobweb-cli/blob/main/kobweb/src/main/kotlin/com/varabyte/kobweb/cli/common/kotter/YesNoChoice.kt
//
//val sampleStory = story("sample") {
//    val me = ColoredActor("Me", Color.CYAN)
//    label("start") {
//        - "The sample story for Kotter enviroment starts here."
//        (me - "Hello there! Want to see some colors?") withColor Color.BRIGHT_YELLOW on this
//        input("inp", "Want to see them?") {
//            setFact("inp", it)
//        }
//    }
//}
//
//fun main() = session {
//    val sstr = sampleStory.getStory()
//    val sb = StoryContentBuilder()
//
//    sstr.forEach {
//        when (it) {
//            is Label -> {
//                it.story?.invoke(sb) ?: println("No story")
//            }
//            else -> {}
//        }
//    }
//
//    if (!sb.hasNext()) sb.reset()
//    while (sb.hasNext()) {
//        when (val it = sb.next()) {
//            is Text -> {
//                    section {
//                        if (it.actor is ColoredActor)
//                            color((it.actor as ColoredActor).color) {
//                                text((it.actor?.name ?: "") + ": ")
//                            }
//                        else
//                            text((it.actor?.name ?: "") + ": ")
//                        if (it is ColoredText)
//                            color(it.color) {
//                                textLine(it.text)
//                            }
//                        else
...
//            else -> {
//                section {
//                    textLine("unknown: $it (${it?.uuid})")
//                }.run()
//            }
//        }
//
//        section { input() }.runUntilKeyPressed(Keys.SPACE, Keys.ENTER)
//    }
//}
