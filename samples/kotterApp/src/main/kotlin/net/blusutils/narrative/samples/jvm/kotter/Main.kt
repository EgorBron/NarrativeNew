...
import net.blusutils.narrative.foundation.label.jumps.ChangeLabelJump.Companion.jumpTo
...
/**
 * Renders a list of [net.blusutils.narrative.stringentity.StringEntity].
